...
//
var secret = "this is my super secret";
var url = "https://laminasolutions.com/services?secure=".concat(secret);
var analyzer = analyzer_1.default.getInstance();
var crawler = new Crawler(url, analyzer, path_1.default.resolve(__dirname, "../data/course.json"));
